        ...
        if (!agreed) {
            ...
            return;
                ...
                api.post("/auth/signup", { name, email, password })
                    .then(result => {
                        console.log('Signup OK', result.data);
                        navigate("/login");
                    })
                    .catch(err => {
                        if (err.response) console.log('Signup error', err.response.data);
                        else console.log('Signup error', err.message);
                    });
        ...
        <section className="vh-100" style={{backgroundColor: "#eee"}}>
            <div className="container h-100">
                ...
                <div className="col-lg-12 col-xl-11">
                    <div className="card text-black" style={{borderRadius: "25px", position: "relative"}}>
                        <div style={{
                            position: "absolute",
                            top: "20px",
                            right: "30px",
                        ...
                        <div className="card-body p-md-5">
                            ...
                            <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <div className="form-check d-flex justify-content-center mb-5">
                                    <input className="form-check-input me-2" type="checkbox" value="" id="form2Example3c" onChange={(e) => setAgreed(e.target.checked)}/>
